...
namespace UnityEngine.Experimental.Rendering.Universal
{
    internal static class RendererLighting
    {
        ...
        static public void CreateBlendStyleRenderTexture(CommandBuffer cmd, int blendStyleIndex)
        {
            ...
            int k_MaxWidth = UniversalRenderPipeline.asset.resolutionWidth;
            int k_MaxHeight = UniversalRenderPipeline.asset.resolutionHeight;

            UniversalRenderPipeline.GetFixResolution(k_MaxWidth, k_MaxHeight,ref width,ref height);

            /*
            width = UniversalRenderPipeline.GetMaxSize(width, k_MaxWidth);
            height = UniversalRenderPipeline.GetMaxSize(height, k_MaxHeight);
            */
        ...
        static public bool CanRenderLightSet(Camera camera, int blendStyleIndex, int layerToRender, List<Light2D> lights)
        {
