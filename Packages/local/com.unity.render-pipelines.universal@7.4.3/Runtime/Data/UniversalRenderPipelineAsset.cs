...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        static public bool s_enableSMAA = false;
...
#pragma warning restore 414
        ...
        // resolution 
        [SerializeField] int m_ResolutionWidth = 720;
        [SerializeField] int m_ResolutionHeight = 1570;
        [SerializeField] int m_BloomIterations = 3;
        ...
        public int resolutionHeight
        {
            ...
            set { m_ResolutionHeight = value; }
        }

        public int bloomIterations
        {
            get { return m_BloomIterations; }
            set { m_BloomIterations = value; }
        }
