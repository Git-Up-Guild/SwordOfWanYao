...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class ForwardRenderer : ScriptableRenderer
    {
        ...
        SimpleSkyBoxRenderPass m_SimpleSkyBoxRenderPass;
        ...
        Material m_SimpleSkyBoxMaterial;
        ...
        public ForwardRenderer(ForwardRendererData data) : base(data)
        {
            ...
            m_SimpleSkyBoxMaterial = CoreUtils.CreateEngineMaterial(data.shaders.simpleSkyBox);
            ...
            m_SimpleSkyBoxRenderPass = new SimpleSkyBoxRenderPass(RenderPassEvent.BeforeRenderingSkybox, m_SimpleSkyBoxMaterial);
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            bool requiresDepthTexture = false;// cameraData.requiresDepthTexture;

            if(ScriptableRenderer.s_requiresDepthTexture)
            {
            ...
            //开始渲染到默认缓存区
            if (IsRender2DefauktTarget())
            {
                createColorTexture = cameraData.postProcessEnabled;
                createDepthTexture = cameraData.postProcessEnabled;
            }
            ...
            if (cameraData.renderType == CameraRenderType.Base)
            {
                ...
                //保持当前base相机的渲染目标
                //activeBaseCameraColorAttachment = m_ActiveCameraColorAttachment;
                //activeBaseCameraDepthAttachment = m_ActiveCameraDepthAttachment;
                ...
                */
                ...
                /*
                if(false == cameraData.postProcessEnabled)
                {
            ...
            if (generateColorGradingLUT&& ColorGradingLutPass.enableLUT)
            {
...
#pragma warning restore 0618
            ...
            if (camera.clearFlags == CameraClearFlags.Skybox && RenderSettings.skybox != null && !isOverlayCamera)
            {
                ...
                //强行更新帧缓存
                ScriptableRenderer.s_forceSetRenderTarget = true;

                /*
                if(s_enableSimpleSkyBox==false)
                {
                    EnqueuePass(m_DrawSkyboxPass);
                }
                else
                {
                    EnqueuePass(m_SimpleSkyBoxRenderPass);
                }
                */
        ...
        void CreateCameraRenderTarget(ScriptableRenderContext context, ref CameraData cameraData)
        {
            ...
            UniversalRenderPipeline.GetFixResolution(UniversalRenderPipeline.asset.resolutionWidth, UniversalRenderPipeline.asset.resolutionHeight, ref width, ref height);
        ...
        //是否支持简单渲染
        public override bool CanSupportSimpeleRender()
        {
            return true;
        }
    }
