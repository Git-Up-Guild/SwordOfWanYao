...
namespace UnityEngine.UI
{
    ...
    public abstract class MaskableGraphic : Graphic, IClippable, IMaskable, IMaterialModifier
    {
        ...
        [NonSerialized]
        private CullStateChangedEvent m_OnCullStateChanged = null;// new CullStateChangedEvent();
        ...
        {
            get {
                if(null== m_OnCullStateChanged)
                {
                    m_OnCullStateChanged = new CullStateChangedEvent();
                }
        ...
        public void OnNotifyCullChange(bool cull)
        {
            if (null != m_OnCullStateChanged)
            {
        ...
        public virtual Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            if (m_ShouldRecalculateStencil)
            {
                if (maskable)
                {
                    var rootCanvas = (canvas != null) ? canvas.transform : null;// MaskUtilities.FindRootSortOverrideCanvas(transform);
