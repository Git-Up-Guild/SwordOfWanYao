    ...
    public class Mask : UIBehaviour, ICanvasRaycastFilter, IMaterialModifier
    {
        ...
        protected override void OnEnable()
        {
            ...
            if (graphic != null)
            {
                ...
                MaskableGraphic mg = graphic as MaskableGraphic;
                if (mg!=null)
                {
                    mg.isMaskingGraphic = true;
                    mg.RecalculateMasking();
                }
        ...
        public virtual Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            Canvas c = transform.GetComponentInParent<Canvas>(false);
            var rootSortCanvas = (c != null) ? c.transform:null;    //MaskUtilities.FindRootSortOverrideCanvas(transform);
