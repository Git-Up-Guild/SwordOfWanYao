...
namespace UnityEngine.UI
{
          ...
          ICanvasElement
    {
        ...
        static public Canvas s_curProcessCanvas = null;
        ...
        protected bool m_hadLayout;
        //protected bool m_checkMeshModify;
       ...
       // [NonSerialized]
        //private  TweenRunner<ColorTween> m_ColorTweenRunner;
        ...
        public virtual void SetLayoutDirty()
        {
            ...
            m_hadLayout = LayoutRebuilder.MarkLayoutForRebuild(rectTransform, this);
        ...
        private void CacheCanvas()
        {
            ...
            if (null!= m_Canvas&& m_Canvas.isActiveAndEnabled)
            {
                //Debug.LogError("节省 canvas 查找");
                return;
            }
        ...
        private void DoMeshGeneration()
        {
            ...
            //if(m_checkMeshModify)
            {
               // m_checkMeshModify = false;
                var components = ListPool<Component>.Get();
...
#pragma warning restore 618
        ...
        //UnityAction<Color> colorCallback = null;
        ColorTween colorTween;
        private bool initColorTween = false;

        static FrameEventMgr s_frameEventMgr = null;
        ...
        public virtual void CrossFadeColor(Color targetColor, float duration, bool ignoreTimeScale, bool useAlpha, bool useRGB)
        {
            ...
            if (currentColor.Equals(targetColor))
            {
                ...
                needUpdateFadeColor = false;
                */

                s_frameEventMgr?.RemoveFrameSink(colorTween);

                return;
            }


            if(s_frameEventMgr==null)
            {
                GameObject gameObject = new GameObject("FrameEvent");
                s_frameEventMgr = gameObject.AddComponent<FrameEventMgr>();   
            ...
            */
            ...
            if(initColorTween==false)
            {
                initColorTween = true;
                colorTween = new ColorTween { duration = duration, startColor = canvasRenderer.GetColor(), targetColor = targetColor };
            ...
            colorTween.elapsedTime = 0.0f;
            s_frameEventMgr?.AddFrameSink(colorTween);
            //needUpdateFadeColor = true;
        ...
        void Update()
        {
            if(needUpdateFadeColor&& colorCallback!=null)
            {
                needUpdateFadeColor = colorTween.OnUpdate();
            }
        }
        */
        ...
        public void SetLayoutFlag(bool hadLayout)
        {
            m_hadLayout = hadLayout;
        }

        public bool HadLayout()
        {
            return m_hadLayout;
        }
    }
